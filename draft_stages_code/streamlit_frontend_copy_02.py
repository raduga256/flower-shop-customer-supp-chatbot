...
#Import vector embedding function 
...
with main_col:
    ...
    if user_input:
        ...
        ## Embedding and enriching the user query with vector_db
        ...
        # Add a system message to display the related_questions chat
    ...
    for i in range(1, len(st.session_state.message_history)+1 ):
        ...
        #streamlit << Extracts>> *chat_message* with role metadata
        ...
        message_box = st.chat_message(this_message["type"]) # Extract chat message user
